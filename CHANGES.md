...
- Changed `PdeBuildTask` and `PdeAntBuildTask` to use `WorkspaceRegistry` allowing parallel (multi threaded) executions of PDE [(#60)](https://github.com/diffplug/goomph/pull/60)
