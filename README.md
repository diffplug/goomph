...
* [`asmaven`](https://javadoc.io/static/com.diffplug.gradle/goomph/3.29.0/com/diffplug/gradle/p2/AsMavenPlugin.html) downloads dependencies from a p2 repository and makes them available in a local maven repository.
