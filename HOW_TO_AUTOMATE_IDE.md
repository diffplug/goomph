...
The next thing is to look at the [javadoc](https://diffplug.github.io/goomph/javadoc/3.6.0/com/diffplug/gradle/oomph/OomphIdePlugin.html) for `OomphIdePlugin`, which inclues a pretty in-depth look at how it works.
